# Prompt: Implement Approach 1.2 Four-Method Suitability Check
...
Implement `Approach 1.2: Four-Method Suitability Check`.
...
experiments/active_fmpe_sbi/posterior_diagnostic_metrics.py
```
...
Use the shared metric style from `posterior_diagnostic_metrics.py` where possible:
...
In `documentation/approach_log/README.md`, mark Approach 1.2 as implemented after running at least a quick smoke test.

...
def design_dim(design_space: str) -> int:
    if design_space == "full":
        return 4
    if design_space in {"window", "hard_window"}:
        return 2
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--design-space",
        choices=("full", "window", "hard_window"),
        default="full",
        help="Design variables BO/random control. Use hard_window to make design choice more consequential.",
    )
